...
export function AboutPage() {
  return (
    <div className="w-full overflow-x-hidden bg-[#F5EFE0]">
      {/* 1 — Page header */}
      <header className={`${gutter} border-b border-[#DDD5C0] py-12 text-center lg:py-20`}>
      ...
      <section aria-labelledby="about-philosophy" className={`${gutter} bg-[#F5EFE0] py-12 lg:py-20`}>
        <div className={`${shell} flex flex-col gap-16 lg:flex-row lg:items-center`}>
          ...
          <div className="order-1 h-[50vh] lg:order-2 lg:h-[70vh] lg:w-[55%]">
            <AiraImage
              fill
      ...
      {/* 4 — The founder */}
      <section aria-labelledby="about-founder" className={`${gutter} bg-[#EDE4D0] py-12 lg:py-20`}>
        <div className={`${shell} flex flex-col gap-16 lg:flex-row lg:items-center`}>
      ...
      {/* 6 — The Aira woman */}
      <section aria-labelledby="about-woman" className={`${gutter} bg-[#F5EFE0] py-12 lg:py-20`}>
        <div className={`${shell} flex flex-col gap-16 lg:flex-row lg:items-center`}>
          <div className="lg:w-[45%]">
              ...
              <li key={collection.handle} className="group">
                ...
                >
                  <AiraImage
                    ...
                    imgClassName="object-top transition-transform duration-[400ms] ease-out motion-safe:group-hover:scale-[1.04] motion-reduce:transition-none"
                  />
      ...
      {/* 8 — Closing */}
      <section aria-labelledby="about-closing" className="bg-[#2C1810] py-12 lg:py-20">
